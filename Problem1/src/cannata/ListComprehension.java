...
public class ListComprehension {
    public static void main(String[] args) {
        ...
        List<Object> e1 = Arrays.asList(10, 'FINANCE',1);
        List<Object> e2 = Arrays.asList(31,'SALES',1);
        List<Object> e3 = Arrays.asList(32, 'SALES', 2);
        List<Object> e4 = Arrays.asList(33, 'SALES', 3);
        List<Object> e5 = Arrays.asList(34, 'SALES',4);
        List<Object> e6 = Arrays.asList(35, 'SALES',5);
        List<Object> e7 = Arrays.asList(41,'OPERATIONS',1);
        List<Object> e8 = Arrays.asList(42,'OPERATIONS',2);
        List<Object> e9 = Arrays.asList(43, 'OPERATIONS',3);
        List<Object> e10 = Arrays.asList(44,'OPERATIONS', 4);
        List<Object> e11 = Arrays.asList(45, 'OPERATIONS',5);
        List<Object> e12 = Arrays.asList(50, 'ADMINISTRATIONAL',5);
        void SalGreaterThan1000{
            s_emp.stream().filter(e -> e. )
        }
